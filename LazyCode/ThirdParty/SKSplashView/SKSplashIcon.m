...
- (instancetype) initWithImage: (UIImage *) iconImage iconSize:(CGSize )iconSize;
{
    self = [super init];
    if(self)
    {
...
- (instancetype) initWithImage: (UIImage *) iconImage animationType: (SKIconAnimationType) animationType iconSize:(CGSize )iconSize
{
    self = [super init];
    if(self)
    {
